...
(function () {
  ...
  */
  ...
  q("Promise", function (a) {
    ...
    b.all = function (g) {
      ...
      return k.done ? d([]) : new b(function (m, p) {
        ...
        do {
          A.push(void 0), I++, d(k.value).G(x(A.length - 1), p), k = h.next();
        } while (!k.done);
      });
    };
  ...
  function zb() {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !M("Presto") && (a = function a() {
      var e = ub("IFRAME");
  ...
  function Rb(a, b, c, d) {
    if (3 == c && b.b && !b.h) for (; a && a.h; a = a.c) {
      a.h = !1;
    }
  ...
  */
  ...
  function sc(a, b) {
    ...
    } else if (a) if (a instanceof sc) for (c = a.C(), d = 0; d < c.length; d++) {
